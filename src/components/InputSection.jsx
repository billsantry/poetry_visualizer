    ...
    return (
        ...
        >
            ...
            <div className="fixed bottom-0 left-0 right-0 text-center z-50 pointer-events-none">
                <p className="text-black/60 text-xs sm:text-base tracking-widest uppercase font-sans font-medium pointer-events-auto w-full bg-black/20 backdrop-blur-sm py-3">
